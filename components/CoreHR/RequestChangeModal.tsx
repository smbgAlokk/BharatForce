...
export const RequestChangeModal: React.FC<Props> = ({ label, currentValue, onClose, onSubmit }) => {
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="p-2 bg-slate-100 rounded text-slate-600 text-sm">{currentValue || '(Empty)'}</div>
          </div>
          <div>
