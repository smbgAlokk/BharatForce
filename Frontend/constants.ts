    ...
    lines: [
      {
        ...
        categoryId: "ec-001",
        amount: 3500,
        description: "Flight Tickets - Delhi",
      },
    ],
  },
];
...
export const MOCK_EXPENSE_ADVANCES: ExpenseAdvance[] = [
  {
    ...
    employeeId: "emp-003",
    amount: 5000,
    reason: "Travel Advance for Mumbai Trip",
    status: "HR Approved",
    requestedOn: "2023-10-01",
    createdAt: new Date().toISOString(),
    createdBy: "Priya Sharma",
    approvedOn: "2023-10-02",
    approvedBy: "Admin",
  },
];
...
export const MOCK_EXIT_CLEARANCE_ITEMS: ExitClearanceItem[] = [
  ...
  }, // HR/Admin
  {
    ...
    itemName: "Pending Expenses Settlement",
    isActive: true,
    createdAt: "",
    createdBy: "",
  }, // Finance
